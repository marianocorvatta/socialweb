      ...
      <div className="max-w-6xl w-full">
        ...
        {profileData && !loading && !generatedSite && (
          <div className="space-y-6">
            {/* Profile summary card with Instagram gradient */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 p-[2px] shadow-xl">
              <div className="rounded-2xl bg-white p-6">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-500 font-medium">@{profileData.profile.username}</p>
                    <div className="flex items-center gap-4 mt-2 text-sm">
                      <span className="text-gray-700">
                        <span className="font-semibold text-gray-900">{profileData.profile.media_count}</span> posts
                      </span>
                      <span className="text-gray-700">
                        <span className="font-semibold text-gray-900">{profileData.profile.followers_count?.toLocaleString() || 0}</span> seguidores
                      </span>
                    </div>
                  </div>
                </div>

                {/* Biography with line breaks preserved */}
