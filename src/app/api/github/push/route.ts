...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.log(`📂 Branch exists, will update (parent: ${parentSha})`);
    } catch {
      console.log(`📂 Branch does not exist, will create orphan commit`);
    }
    ...
    if (instagramUsername && process.env.VERCEL_TOKEN) {
      ...
      try {
        ...
        while (
          ...
          attempts++;
          console.log(`📊 Status (${attempts}): ${deploymentStatus}`);
        }
        ...
        console.error("❌ Vercel error:", deployError);
        deploymentResult = {
          success: false,
